import { Component, ElementRef, Host, Input, Renderer2 } from '@angular/core';
...
export class PipSliderButtonComponent {
  ...
  constructor(private renderer: Renderer2, private elRef: ElementRef, @Host() pSlider: PipSliderComponent) {
    this.renderer.addClass(this.elRef.nativeElement, 'forward');
    if (pSlider instanceof PipSliderComponent) {
      this.parentSlider = pSlider;
    }
  }
